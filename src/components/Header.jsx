        ...
        <header className='fixed z-50 w-screen p-3 px-4 md:p-6 md:px-16 bg-primary'>
            ...
            <div className='hidden md:flex w-full h-full items-center justify-between'>
                <Link to={'/'} className='flex item-center gap-2'>
                    ...
                    <p className='text-headingcolor text-xl font-bold'> City Eats</p>
                </Link>

                <div className='flex items-center gap-[2.25vw]'>
                    <motion.ul
                ...
                transition-all ease-out cursor-pointer'>Menu</li>
                        <li className='text-base text-headingColor hover:text-headingColor duration-100
                transition-all ease-out cursor-pointer'>About Us</li>
                        <li className='text-base text-headingColor hover:text-headingColor duration-100
                transition-all ease-out cursor-pointer'>Service</li>
                    </motion.ul>
                    ...
                    <div className='relative'>
                        ...
                        <motion.img
                            ...
                            whileTap={{ scale: 0.6 }}
                            className='w-10 min-w-[40px] h-10m min-h-[40px] drop-shadow-x cursor-pointer rounded-full'
                            alt='userProfile'
                            onClick={login}
                        />
                        {
                            isMenu && (
                                <motion.div initial={{ opacity: 0, scale: 0.6 }}
                                    ...
                                    {
                                        user && user.email === "alahlybeaue@gmail.com" && (
                                            <Link to={'/createItem'}>
                        ...
                        isMenu && (
                            <motion.div initial={{ opacity: 0, scale: 0.6 }}
                                ...
                                <p className='m-2 p-2 rounded-md shadow-md flex items-center justify-center
                                    bg-gray-200 gap-3 cursor-pointer hover:bg-gray-300 transition-all
